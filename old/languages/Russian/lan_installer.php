...
define("LANINS_018", "Пожалуйста, убедитесь, что все перечисленные файлы существуют и на них открыт права на запись для сервера. Обычно это означает CHMOD = 777, но окружения различаются - проконсультируйтесь с хост-провайдером, если у вас есть какие-либо проблемы.");
