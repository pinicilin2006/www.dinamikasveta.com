...
define("PRFLAN_64", "Нажмите кнопку, чтобы отправить тестовое сообщение на адрес Админа");
...
define("MAILAN_31", "Обработка отрицательных квитанций"); // Bounced Email Processing
...
define("MAILAN_36", "Удалить отрицательные квитанции после проверки"); //Delete Bounced Mails after checking
