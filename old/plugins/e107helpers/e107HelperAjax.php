 ...
 * <b>CVS Details:</b>
 * <ul>
 * <li>$Source: e:\_repository\e107_plugins/e107helpers/e107HelperAjax.php,v $</li>
 * <li>$Date: 2007/01/18 21:41:13 $</li>
 * </ul>
 * @author     $Author: Neil $
      ...
      case "addCustomField" : {
         ...
         switch ($step) {
            case 1 : {
               ...
               $body .= "Select the field type:&nbsp;";
               $body .= "<select class='tbox' id='{$id}_select'>";
               $body .= "<option value='text'>Text</option>";
               $body .= "<option value='textarea'>Text area</option>";
               $body .= "<option value='select'>Select (list)</option>";
//               $body .= "<option value='date'>Date</option>";
               $body .= "<option value='checkbox'>Checkbox</option>";
               $body .= "<option value='radio'>Radio buttons</option>";
               $body .= "</select>";
