...
var e107Helper = {
   ...
   editInline : function(fieldType, itemId, fieldName, jsfunc, prefix, postfix) {
      ...
      var el  = document.getElementById(thehiddentextspan);
      if (!el) {
         el = document.getElementById(thetextspan);
      }
      var oldText = el.firstChild.nodeValue;
      //var oldText = document.getElementById(thespan).firstChild.firstChild.nodeValue;
      ////var oldText = document.getElementById(thespan).firstChild.innerHTML;
      ...
      document.getElementById(thespan).oldHTML = document.getElementById(thespan).innerHTML;
      document.getElementById(thespan).innerHTML = inlineField;
      document.getElementById(newId).value = oldText;
      resizeTextArea(document.getElementById(newId));
   ...
   editInlineCancel : function(fieldName) {
      ...
      var thespan = document.getElementById("e107helper_"+fieldName);
      thespan.innerHTML = thespan.oldHTML;
      document.getElementById("e107helper_"+fieldName+"_a").focus();
   },
   ...
   parseForm : function(fieldType, fieldName) {
      ...
      newHTML += document.getElementById(newId).value;
      newHTML += "</span>";
...
//      var req = this.getRequester();
   ...
   addParm : function(name, value) {
      ...
      this.parms += escape(name) + "=" + encodeURI(value);
   },
      ...
      if (req.responseXML == null) {
         ...
         for (i=0; i<nodes.length ; i++) {
            ...
            switch (nodes[i].getAttribute("type")) {
               ...
               case "innerhtml" : {
                  e107Helper.logInfo(nodes[i].getAttribute("id"));
   ...
   resetCustomField : function(uri, id) {
      ...
      this.addParm("id", id);
      document.getElementById(id).value = 'a:1:{s:24:"e107HelperCustomField_id";s:18:"'+id+'";}';
      this.addParm("customfields", document.getElementById(id).value);
      this.post(uri);
   },
