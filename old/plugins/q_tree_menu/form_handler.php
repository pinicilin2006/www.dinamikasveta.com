...
// --------------------------------- Chechbox --------------------------------
	case "checkbox":
                            ...
                            for ($i=0; $i<count($tmp); $i++) {
                            //$checked = ($tmp[$i] == $presetvalue)? " checked='checked'" : "";
                            $checked = ($presetvalue==1)? " checked='checked'" : "";
                            $ret .="<input  type='checkbox' name='".$fieldname."'  value='1' $checked /><br />";
                            };
                          break;
...
// --------------------------------- Textbox --------------------------------
	case "text":
                            ...
                            // $size = ($tmp[1]) ? $tmp[1]:40;
                            $ret .="<input class='tbox' type='text' name='".$fieldname."' size='40' value='".htmlentities($valuehere) ."' maxlength='200' />";
...
// --------------------------------- Color Selector --------------------------------
	case "color":
                            ...
                            $ret = Q_Color_Select($fieldname,$presetvalue);
...
// <![CDATA[
    ...
    function ValidateColor(string) {                // return valid color code
      ...
      //if (out.length != 6 || out.length != 1) { return null; }            // check length
      //if (out.length == 0) {out = ' ';)
      return out;
    }
// ]]>
...
function Q_Color_Select($field,$dbvalue){
 ...
 /* $text .="<table cellspacing=\"0px\" cellpadding=\"4\" style='width:100%;border:0px'>
  ...
  $text .="
    ...
    <tr>
    <td style='width:10px;height:10px;background-color:#000000' onmouseover=\"View('".$field."','000000')\" onclick=\"Set('".$field."','000000')\" ></td>
    <td style='width:10px;height:10px;background-color:white' onmouseover=\"View('".$field."','TTTTTT')\" onclick=\"Set('".$field."','TTTTTT')\" ></td>
    <td style='width:10px;height:10px;background-color:#000000' onmouseover=\"View('".$field."','000000')\" onclick=\"Set('".$field."','000000')\" ></td>
